...
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "@type") // Aqui está dizendo que a classe pagamento vai ter um campo adicional chamado '@type'
